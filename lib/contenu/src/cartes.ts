...
const lignesRouges: CarteContenu[] = [
  ...
  // ── Interdits francs ──────────────────────────────────────────────────────
  //
  // Des actes assez nets pour que la question « qu'est-ce qui te ferait
  // franchir cette limite ? » ait un vrai poids. On mélange le criminel, le
  // moral et l'incivilité révélatrice : l'échelle elle-même fait réfléchir.
  {
    id: "JV1036",
    famille: "lignes_rouges",
    label: "Tuer quelqu'un",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.justice, V.securite],
  ...
  },
  {
    id: "JV1038",
    famille: "lignes_rouges",
    label: "Torturer quelqu'un",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.justice, V.entraide],
  },
  {
    id: "JV1039",
    famille: "lignes_rouges",
    label: "Enlever quelqu'un contre sa volonté",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.liberte, V.justice],
  },
  {
    id: "JV1040",
    famille: "lignes_rouges",
    label: "Mettre le feu volontairement à un bâtiment occupé",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.securite, V.justice],
  },
  {
    id: "JV1041",
    famille: "lignes_rouges",
    label: "Renverser quelqu'un et prendre la fuite",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.courage, V.honnetete],
  },
  {
    id: "JV1042",
    famille: "lignes_rouges",
    label: "Fabriquer une fausse preuve",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.honnetete, V.justice],
  },
  {
    id: "JV1043",
    famille: "lignes_rouges",
    label: "Acheter le silence d'une victime",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.justice, V.honnetete],
  },
  {
    id: "JV1044",
    famille: "lignes_rouges",
    label: "Abandonner un animal",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.nature, V.entraide],
  },
  {
    id: "JV1045",
    famille: "lignes_rouges",
    label: "Vendre de la drogue à un enfant",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.securite, V.justice],
  },
  {
    id: "JV1046",
    famille: "lignes_rouges",
    label: "Participer à une fraude organisée",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.honnetete, V.regles],
  ...
  },
  {
    id: "JV1048",
    famille: "lignes_rouges",
    label: "Profaner une tombe",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.famille, V.regles],
  },
  {
    id: "JV1049",
    famille: "lignes_rouges",
    label: "Laisser mon panier d'épicerie au milieu du stationnement",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.entraide, V.regles],
  },
  {
    id: "JV1050",
    famille: "lignes_rouges",
    label: "Stationner dans une place réservée aux personnes handicapées",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.justice, V.regles],
  },
  {
    id: "JV1051",
    famille: "lignes_rouges",
    label: "Jeter mes déchets dans la rue",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.nature, V.regles],
  },
  {
    id: "JV1052",
    famille: "lignes_rouges",
    label: "Ne pas ramasser les dégâts de mon animal",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.entraide, V.regles],
  },
  {
    id: "JV1053",
    famille: "lignes_rouges",
    label: "Passer devant tout le monde dans une file",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.justice, V.regles],
  },
  {
    id: "JV1054",
    famille: "lignes_rouges",
    label: "Garder un portefeuille trouvé",
    description: null,
    origine: "maison" as const,
    categorie: null,
    valeursSuggerees: [V.honnetete, V.entraide],
  },
];
/** 2000-2999 : horizons. */
